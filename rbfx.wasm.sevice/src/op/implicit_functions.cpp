...
double octic_function( double x, double y, double z )
{  // r=2
    double x2 = x * x, y2 = y * y, z2 = z * z;
    double x4 = x2 * x2, y4 = y2 * y2, z4 = z2 * z2;
    ...
    return 43.30495169 * x2 * y2 + 43.30495169 * x2 * z2 + 43.30495169 * y2 * z2 + 44.36067980 * x6 * y2 + 44.36067980 * x6 * z2 + 66.54101970 * x4 * y4 + 66.54101970 * x4 * z4 + 44.36067980 * x2 * y6 - 11.70820393 * x2 - 11.70820393 * y2 - 11.70820393 * z2 + 37.65247585 * x4 + 37.65247585 * y4
           + 37.65247585 * z4 + 11.09016995 * x8 + 11.09016995 * y8 + 11.09016995 * z8 + 133.0820394 * x2 * y4 * z2 + 133.0820394 * x2 * y2 * z4 + 44.36067980 * x2 * z6 + 44.36067980 * y6 * z2 + 66.54101970 * y4 * z4 + 44.36067980 * y2 * z6 + 133.0820394 * x4 * y2 * z2 - 91.95742756 * x4 * y2
           - 91.95742756 * x4 * z2 - 91.95742756 * x2 * y4 - 91.95742756 * x2 * z4 - 91.95742756 * y4 * z2 - 183.9148551 * x2 * y2 * z2 - 30.65247585 * x6 - 30.65247585 * y6 - 91.95742756 * y2 * z4 - 30.65247585 * z6 + 1.618033988;
}

// "Heart"

double heart_function( double x, double y, double z )
{  // radius = 2
...
double klein_function( double x, double y, double z )
{  // radius = 4
...
double ring_function( double x, double y, double z )
{  // radius = ?
    double e = 0.1;
...
double false_knot_function( double x, double y, double z )
{  // radius = 1
    double d = 1.2, e = 0.1;
...
double knot1_function( double a, double b, double c )
{  // radius = 4
    double e = 0.1;
...
double knot1_surf2_function( double x, double y, double z )
{  // radius = 4
    double c1, c2, c3, c4, den;
    den = 1 + x * x + y * y + z * z;
    c1  = 2 * x / den;
...
double knot2_function( double a, double b, double c )
{  // radius = 4
    double e = 0.025;
...
double knot3_function( double a, double b, double c )
{  // radius = 4
    double e = 0.025;
